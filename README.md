...
git clone [git@github.com:christianonoh/Bookstore.git](git@github.com:christianonoh/Bookstore.git)
<!--
Example commands:
...
Feel free to check the [issues page](https://github.com/christianonoh/Bookstore/issues).
